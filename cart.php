...
<form action="actions/mail.php" method="post" class="order">
    <input type="text" name="username" id="" required placeholder="Ваше имя">
    <input type="text" name="phone" id="" required placeholder="Ваш телефон">
    <input type="email" name="email" id="" required placeholder="Ваш email">
    <input type="submit" name="order" id="" required placeholder="Отправить заказ">
</form>
